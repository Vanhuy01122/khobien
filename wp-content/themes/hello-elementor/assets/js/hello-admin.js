/******/ (() => {
  ...
  /******/ var __webpack_modules__ = {
    /***/ 696: /***/ (__unused_webpack_module, exports) => {
      "use strict";
      ...
      const ActionLinks = ({ image, alt, title, message, button, link }) => {
    ...
    /***/ 19: /***/ (__unused_webpack_module, exports, __webpack_require__) => {
      ...
      const Notices = () => {
        const notices = (0, _data.useSelect)(
          (select) =>
        ...
        const { removeNotice } = (0, _data.useDispatch)(_notices.store);
      ...
      const SettingsPage = () => {
        ...
        const saveSettings = () => {
          const data = {};
          Object.values(SETTINGS).forEach(
            (value) =>
              (data[`${settingsPrefix}${value}`] = settingsData[value]
                ? "true"
                : "")
          );
          const settings = new _api.default.models.Settings(data);
          settings.save();
          (0, _data.dispatch)("core/notices").createNotice(
            "success",
            (0, _i18n.__)("Settings Saved", "hello-elementor"),
            {
              type: "snackbar",
              isDismissible: true,
            }
        ...
        (0, _react.useEffect)(() => {
          const fetchSettings = async () => {
            try {
              ...
              const data = {};
              Object.values(SETTINGS).forEach(
                (value) => (data[value] = response[`${settingsPrefix}${value}`])
              );
        ...
        if (!hasLoaded) {
          return /*#__PURE__*/ React.createElement(
            ...
            null,
            /*#__PURE__*/ React.createElement(_components.Spinner, null)
          );
        }
        return /*#__PURE__*/ React.createElement(
          _react.Fragment,
            ...
            /*#__PURE__*/ React.createElement(
              ...
              /*#__PURE__*/ React.createElement(
                ...
                /*#__PURE__*/ React.createElement(
                  "h1",
                  null,
                  (0, _i18n.__)("Hello Theme Settings", "hello-elementor")
                )
              )
            )
          ),
          /*#__PURE__*/ React.createElement(
            ...
            /*#__PURE__*/ React.createElement(
              _components.Panel,
              null,
              /*#__PURE__*/ React.createElement(_settingsPanel.SettingsPanel, {
                SETTINGS,
                settingsData,
                updateSettings,
              }),
              /*#__PURE__*/ React.createElement(
                ...
                (0, _i18n.__)("Save Settings", "hello-elementor")
              )
            ),
            /*#__PURE__*/ React.createElement(
              _actionLinksPanel.ActionLinksPanel,
              null
            )
          ),
          /*#__PURE__*/ React.createElement(
    ...
    /***/ 442: /***/ (
      ...
      const actionLinks = {
        "install-elementor": {
          ...
          message: (0, _i18n.__)(
            "Create cross-site header & footer using Elementor.",
            "hello-elementor"
          ),
        ...
        "activate-header-footer-experiment": {
          ...
          message: (0, _i18n.__)(
            'Design your cross-site header & footer from Elementor’s "Site Settings" panel.',
            "hello-elementor"
          ),
          button: (0, _i18n.__)(
            "Activate header & footer experiment",
        ...
        "style-header-footer": {
          ...
          alt: (0, _i18n.__)("Elementor", "hello-elementor"),
          title: (0, _i18n.__)(
            "Style cross-site header & footer",
            "hello-elementor"
          ),
          message: (0, _i18n.__)(
            'Customize your cross-site header & footer from Elementor’s "Site Settings" panel.',
            "hello-elementor"
          ),
      ...
      const ActionLinksPanel = () => {
        ...
        return /*#__PURE__*/ React.createElement(
          ...
          actionLinks[helloAdminData.actionLinkType]
        );
      };
    ...
    /***/ 425: /***/ (
      ...
      var _i18n = __webpack_require__(723);
      var _components = __webpack_require__(427);
      const SettingsPanel = ({ SETTINGS, settingsData, updateSettings }) => {
        ...
        return /*#__PURE__*/ React.createElement(
          ...
          /*#__PURE__*/ React.createElement(
            ...
            (0, _i18n.__)(
              "Be cautious, disabling some of the following options may break your website.",
              "hello-elementor"
            )
          ),
          /*#__PURE__*/ React.createElement(_components.ToggleControl, {
            ...
            help: (0, _i18n.__)(
              "Remove the description meta tag in singular content pages that contain an excerpt.",
              "hello-elementor"
            ),
            checked: !!settingsData[SETTINGS.DESCRIPTION_META_TAG] || false,
            onChange: (value) =>
              updateSettings(SETTINGS.DESCRIPTION_META_TAG, value),
          }),
          /*#__PURE__*/ React.createElement(
            "code",
            {
          ...
          /*#__PURE__*/ React.createElement(_components.ToggleControl, {
            ...
            help: (0, _i18n.__)(
              'Remove the "Skip to content" link used by screen-readers and users navigating with a keyboard.',
              "hello-elementor"
            ),
          ...
          /*#__PURE__*/ React.createElement(_components.ToggleControl, {
            ...
            help: (0, _i18n.__)(
              "Remove the header & footer sections from all pages, and their CSS/JS files.",
              "hello-elementor"
            ),
          ...
          /*#__PURE__*/ React.createElement(_components.ToggleControl, {
            ...
            help: (0, _i18n.__)(
              "Remove the section above the content that contains the main heading of the page.",
              "hello-elementor"
            ),
          ...
          /*#__PURE__*/ React.createElement(_components.ToggleControl, {
            ...
            help: (0, _i18n.__)(
              "Disable Hello theme's theme.css file which contains CSS rules that style WordPress elements.",
              "hello-elementor"
            ),
